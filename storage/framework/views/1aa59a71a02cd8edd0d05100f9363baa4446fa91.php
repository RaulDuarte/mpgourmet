<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('translation.singlemeal'); ?>
                    ...
                    <div class="row gy-3">
                        <div class="col-sm-auto">
                            <div class="avatar-lg bg-light rounded p-1">
                                <img src="<?php echo e(URL::asset('assets/images/products/cup-of-coffee-juice-eggs-fruits-toasts-breakfast-concept.jpg')); ?>" alt="" class="img-fluid d-block">
                            </div>
                        </div>
                        <div class="col-sm">
            ...
            <div class="card product">
                <div class="card-body">
                    <div class="row gy-3">
                        <div class="col-sm-auto">
                            <div class="avatar-lg bg-light rounded p-1">
                                <img src="<?php echo e(URL::asset('assets/images/products/roasted-and-grilled-sausage-smoked-pork-served-hot-with-rice-and-beans-farofa-tomato-salad-and-fries-typical-minas-gerais-food-brazilian-lunch.jpg')); ?>" alt="" class="img-fluid d-block">
                            </div>
                        </div>
                        <div class="col-sm">
                            <h5 class="fs-14 text-truncate"><a href="<?php echo e(URL::asset('/ecommerce-product-detail')); ?>"
            ...
            <div class="card product">
                <div class="card-body">
                    <div class="row gy-3">
                        <div class="col-sm-auto">
                            <div class="avatar-lg bg-light rounded p-1">
                                <img src="<?php echo e(URL::asset('assets/images/products/ham-and-cheese-sandwich-on-picnic-cloth.jpg')); ?>" alt="" class="img-fluid d-block">
                            </div>
                        </div>
                        <div class="col-sm">
                            <h5 class="fs-14 text-truncate"><a href="<?php echo e(URL::asset('/ecommerce-product-detail')); ?>"
            ...
            <div class="card product">
                <div class="card-body">
                    <div class="row gy-3">
                        <div class="col-sm-auto">
                            <div class="avatar-lg bg-light rounded p-1">
                                <img src="<?php echo e(URL::asset('assets/images/products/rice-with-potatoes-and-meat.jpg')); ?>" alt="" class="img-fluid d-block">
                            </div>
                        </div>
                        <div class="col-sm">
                            <h5 class="fs-14 text-truncate"><a href="<?php echo e(URL::asset('/ecommerce-product-detail')); ?>"
        ...
        <div class="col-xl-4">
            <div class="sticky-side-div">
                ...
                <div class="text-end mb-4">
                    <a href="<?php echo e(URL::asset('/apps-ecommerce-checkout')); ?>" class="btn btn-warning btn-label right ms-auto"><i
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/raul/Workspace/mpgourmet/resources/views/apps-ecommerce-cart.blade.php ENDPATH**/ ?>