...
<?php $__env->startSection('content'); ?>
    ...
    <div class="d-flex align-items-start gap-3 mt-4 mb-5">
        <a href="<?php echo e(URL::asset('/pages-pricing')); ?>" class="btn btn-light btn-label previestab"><i
            class="ri-arrow-left-line label-icon align-middle fs-16 me-2"></i>Voltar</a>
        
        <a href="<?php echo e(URL::asset('/apps-ecommerce-checkout-month')); ?>" class="btn btn-success btn-label right ms-auto nexttab"><i
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/raul/Workspace/mpgourmet/resources/views/pages-pricing-date.blade.php ENDPATH**/ ?>