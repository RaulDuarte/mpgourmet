                                    ...
                                    <form action="index">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="username"
                                                placeholder="Insira o email" value="<?php echo e(old('email', 'admin@themesbrand.com')); ?>">
                                        </div>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/raul/Workspace/mpgourmet/resources/views/auth-signin-basic.blade.php ENDPATH**/ ?>