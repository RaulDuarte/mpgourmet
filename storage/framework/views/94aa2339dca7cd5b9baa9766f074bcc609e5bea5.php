            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle shadow-none" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <?php break; ?>
                        <?php default: ?>
                        <img src="<?php echo e(URL::asset('/assets/images/flags/br.svg')); ?>" class="rounded " alt="Header Language" height="18">
                        <?php break; ?>
                        <?php endswitch; ?>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <!-- item-->
                        <a href="<?php echo e(url('index/br')); ?>" class="dropdown-item notify-item language py-2" data-lang="br" title="Português">
                            <img src="<?php echo e(URL::asset('assets/images/flags/br.svg')); ?>" alt="user-image" class="me-2 rounded" height="18">
                            <span class="align-middle">Português</span>
                        </a>

                        <!-- item-->
                        <a href="<?php echo e(url('index/en')); ?>" class="dropdown-item notify-item language py-2" data-lang="en" title="Inglês">
                        ...
                        <!-- item-->
                        <a href="<?php echo e(url('index/sp')); ?>" class="dropdown-item notify-item language" data-lang="sp" title="Espanhol">
                ...
                <!-- Modo Escuro - Necessário referenciar o script correto caso queira ativar
                <div class="ms-1 header-item d-none d-sm-flex">
                ...
                <div class="dropdown topbar-head-dropdown ms-1 header-item" id="notificationDropdown">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle shadow-none" id="page-header-notifications-dropdown" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false">
                        ...
                        <span class="position-absolute topbar-badge fs-10 translate-middle badge rounded-pill bg-warning">3<span class="visually-hidden">não lidas</span></span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0" aria-labelledby="page-header-notifications-dropdown">

                        <div class="dropdown-head bg-dark rounded-top">
                            <div class="p-3">
                                <div class="row align-items-center">
                                    <div class="col">
                                    ...
                                    <div class="col-auto dropdown-tabs">
                                        <span class="badge badge-soft-warning fs-13"> 4 Novos</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-content position-relative" id="notificationItemsTabContent">
                                ...
                                <div data-simplebar style="max-height: 300px;" class="pe-2">
                                    ...
                                    <div class="my-3 text-center view-all">
                                        <button type="button" class="btn btn-soft-warning waves-effect waves-light">
                                            Ver Todas Notificações <i class="ri-arrow-right-line align-middle"></i></button>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade py-2 ps-2" id="messages-tab" role="tabpanel" aria-labelledby="messages-tab">
                                <div data-simplebar style="max-height: 300px;" class="pe-2">
                                    ...
                                    <div class="my-3 text-center view-all">
                                        <button type="button" class="btn btn-soft-warning waves-effect waves-light">
                                            Ver Todas Mensagens <i class="ri-arrow-right-line align-middle"></i></button>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="pages-profile"><i class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i> <span class="align-middle"><?php echo app('translator')->get('translation.profile'); ?></span></a>
                        ...
                        <a class="dropdown-item" href="pages-faqs"><i class="mdi mdi-lifebuoy text-muted fs-16 align-middle me-1"></i> <span class="align-middle"><?php echo app('translator')->get('translation.help'); ?></span></a>
                        ...
                        <a class="dropdown-item" href="pages-profile-settings"><i class="mdi mdi-cog-outline text-muted fs-16 align-middle me-1"></i> <span class="align-middle"><?php echo app('translator')->get('translation.settings'); ?></span></a>
                        <a class="dropdown-item" href="auth-lockscreen-basic"><i class="mdi mdi-lock text-muted fs-16 align-middle me-1"></i> <span class="align-middle"><?php echo app('translator')->get('translation.lock-screen'); ?></span></a>
...
<?php /**PATH /home/raul/Workspace/mpgourmet/resources/views/layouts/topbar.blade.php ENDPATH**/ ?>