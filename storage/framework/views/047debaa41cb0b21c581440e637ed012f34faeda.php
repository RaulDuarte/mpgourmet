...
<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        ...
        <a href="index" class="logo logo-light">
            <span class="logo-sm">
                <img src="<?php echo e(URL::asset('assets/images/logos/mp-sm-logo.png')); ?>" alt="" height="22">
            </span>
            <span class="logo-lg">
                <img src="<?php echo e(URL::asset('assets/images/logos/mp-logo.png')); ?>" alt="" height="100">
            </span>
        </a>
    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                <li class="menu-title"><span><?php echo app('translator')->get('translation.management'); ?></span></li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="index" data-bs-toggle="none" role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                        <i class="las la-chart-pie"></i> <span><?php echo app('translator')->get('translation.dashboards'); ?>
                        </span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="apps-ecommerce-customers" data-bs-toggle="none" role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                        <i class="las la-user-friends"></i> <span><?php echo app('translator')->get('translation.clients'); ?>
                        </span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="apps-ecommerce-customers" data-bs-toggle="none" role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                        <i class="las la-graduation-cap"></i> <span><?php echo app('translator')->get('translation.students'); ?>
                        </span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="apps-ecommerce-orders" data-bs-toggle="none" role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                        <i class="las la-shopping-cart"></i> <span><?php echo app('translator')->get('translation.orders'); ?>
                        </span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="apps-ecommerce-products" data-bs-toggle="none" role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                        <i class="las la-box"></i> <span><?php echo app('translator')->get('translation.packages'); ?>
                        </span>
                    </a>
                </li>
                ...
                <li class="menu-title"><span><?php echo app('translator')->get('translation.quick-access'); ?></span></li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="pages-profile" data-bs-toggle="none" role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                        <i class="las la-user-circle"></i> <span><?php echo app('translator')->get('translation.profile'); ?>
                        </span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="pages-pricing" data-bs-toggle="none" role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                        <i class="las la-file-contract"></i> <span><?php echo app('translator')->get('translation.month-packages'); ?>
                        </span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="apps-ecommerce-cart" data-bs-toggle="none" role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                        <i class="las la-utensils"></i> <span><?php echo app('translator')->get('translation.detached-packages'); ?>
                        </span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="pages-privacy-policy" data-bs-toggle="none" role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                        <i class="las la-user-shield"></i> <span><?php echo app('translator')->get('translation.privacy-policy'); ?>
                        </span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="pages-term-conditions" data-bs-toggle="none" role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                        <i class="las la-exclamation-triangle"></i> <span><?php echo app('translator')->get('translation.terms-conditions'); ?>
                        </span>
                    </a>
                </li>
...
<?php /**PATH /home/raul/Workspace/mpgourmet/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>