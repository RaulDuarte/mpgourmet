    ...
    <nav class="navbar navbar-expand-lg navbar-landing fixed-top" id="navbar">
        <div class="container">
            <a class="navbar-brand" href="{{URL::asset('/index')}}">
                <img src="{{ URL::asset('assets/images/logos/Logotipo-M&P-Gourmet_colorido-fundo-transparente2.png') }}" class="card-logo card-logo-dark" alt="logo dark" height="60">
                <img src="{{ URL::asset('assets/images/logos/Logotipo-M&P-Gourmet_colorido-fundo-transparente2.png') }}" class="card-logo card-logo-light" alt="logo light"
                    height="17">
            </a>
            ...
            <div class="row align-items-center" style="height: 100vh">
                <div class="col-lg-8 col-sm-10" style="margin-top: -17rem">
                    ...
                    <div class="d-flex gap-2 mt-4">
                        <a href="{{URL::asset('/pages-pricing')}}" class="btn btn-lg btn-danger">Crie sua Conta</a>
                    </div>
                    -->
        ...
        <div class="container">
            <div class="row align-items-center gy-4">
                ...
                <div class="col-lg-6 col-sm-7 col-10 ms-auto order-1 order-lg-2">
                    <div>
                        <img src="{{ URL::asset('assets/images/landing/features/basket-full-of-vegetables.jpg') }}" alt="" class="img-fluid">
                    </div>
                </div>
            </div>
            <!-- end row -->
            ...
            <div class="row align-items-center mt-5 pt-lg-5 gy-4">
                <div class="col-lg-6 col-sm-7 col-10 mx-auto">
                    <div>
                        <img src="{{ URL::asset('assets/images/landing/features/delicious-salad-with-pasta-and-seafood-in-beautiful-plate.jpg') }}" alt="" class="img-fluid">
                    </div>
                </div>
                <div class="col-lg-6">
        ...
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class="col-lg-2">
                    <div>
                        <div>
                            <img src="{{ URL::asset('assets/images/logos/mp-logo.png') }}" alt="logo light" height="100">
                        </div>
                    </div>
                </div>
